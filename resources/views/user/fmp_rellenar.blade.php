    ...
    <div class="col-sm-12 col-md-6  col-lg-6">
      <div class="row justify-content-around">
        ...
        <div class="col-10 text-left p-0">
          <select class="text-left form-select form-control mt-1">
...
<!-- COLUMNA DE LOS "DATOS DEL TRANSPORTE" -->
    <div class="col-sm-12 col-md-6 col-lg-6">
      <div class="row justify-content-around">
        ...
        <div class="col-10 text-left p-0">
          <select class="text-left form-select form-control mt-2">
  ...
  <div class="row justify-content-between">
    ...
    <div class="col-sm-12 col-md-12 col-lg-4 my-2">
      <div class="row justify-content-center border">
        ...
        <div class="col-6">
          <input type="number" step="any" class="form-control" placeholder="(°C)">
        </div>   
      </div>
    </div>
    ...
    <div class="col-sm-12 col-md-12 col-lg-4 my-2">
      <div class="row justify-content-center border">
        ...
        <div class="col-6">
          <input type="number" step="any" class="form-control" placeholder="(g/l)">
        </div>   
      </div>
    </div>
...
<div class="row justify-content-between">
    ...
    <div class="col-sm-12 col-md-12 col-lg-4 my-2">
      <div class="row justify-content-center border">
        ...
        <div class="col-6">
          <input type="number" step="any" class="form-control" placeholder="(Kg)">
        </div>
      </div>
    </div>
...
<div class="row justify-content-between">
    ...
    <div class="col-sm-12 col-md-12 col-lg-6 my-2">
      <div class="row justify-content-center border">
        ...
        <div class="col-6">
          <select class="text-left form-select mt-1 form-control">
