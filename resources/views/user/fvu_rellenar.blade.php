                ...
                <div class="row mt-4 d-flex justify-content-center" >
                    ...
                    <div class="col-6 border">
                        ...
                        <div class="row d-flex justify-content-center mt-2">
                            ...
                            <div class="col-auto m-2 ">
                                <input type="radio" class="btn-check" name="vehiculo" id="torton1" autocomplete="off">
                                <label class="btn btn-outline-secondary" for="torton1">Torton</label>
                            </div>
                        
                            <div class="col-auto m-2 ">
                                <input type="radio" class="btn-check" name="vehiculo" id="trailer1" autocomplete="off">
                    ...
                    <div class="col-6 border">
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-auto m-2 ">
                                <input type="radio" class="btn-check" name="btnradio" id="caja_seca1" autocomplete="off">
                                <label class="btn btn-outline-secondary" for="caja_seca1">Caja Seca</label>      
                            </div>
                        
                            <div class="col-auto m-2 ">
                                <input type="radio" class="btn-check" name="btnradio" id="gondola1" autocomplete="off">
                                <label class="btn btn-outline-secondary" for="gondola1">Gondola</label>    
                            </div>
                
                            <div class="col-auto m-2 ">
                                <input type="radio" class="btn-check" name="btnradio" id="plataforma" autocomplete="off">
